...
[![shiny.navbarlogo status badge](https://llongour.r-universe.dev/badges/shiny.navbarlogo)](https://llongour.r-universe.dev)
<!-- badges: end -->
...
You can install the development version of shiny.navbarlogo from [GitHub](https://github.com/) with:
